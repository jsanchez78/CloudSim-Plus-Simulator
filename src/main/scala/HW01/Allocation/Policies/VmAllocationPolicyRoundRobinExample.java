...
public class VmAllocationPolicyRoundRobinExample {
    ...
    private VmAllocationPolicyRoundRobinExample() {
        ...
        VMS = Integer.parseInt(config.getString("default.VMS"));
        VM_PES = Integer.parseInt(config.getString("default.VM_PES"));
    ...
    private List<Cloudlet> createCloudlets() {
        ...
        final UtilizationModelDynamic utilizationModel = new UtilizationModelDynamic(0.50);
