...
public class dynamicLoadBalancing {
    ...
    private static Integer SCHEDULING_INTERVAL;
    private static int VM_RAM;
    private static int CLOUDLETS_INITIAL_LENGTH;
     ...
     */
    private dynamicLoadBalancing() {
        /*Enables just some level of log messages.
          Make sure to import org.cloudsimplus.util.Log;*/
        //Log.setLevel(ch.qos.logback.classic.Level.WARN);
        Config config = ConfigFactory.load("inputs.conf");
        HOSTS = Integer.parseInt(config.getString("dynamicLoadBalancing.HOSTS"));
        HOST_PES = Integer.parseInt(config.getString("dynamicLoadBalancing.HOST_PES"));
        VMS = Integer.parseInt(config.getString("dynamicLoadBalancing.VMS"));
        VM_PES = Integer.parseInt(config.getString("dynamicLoadBalancing.VM_PES"));
        CLOUDLETS = Integer.parseInt(config.getString("dynamicLoadBalancing.CLOUDLETS"));
        CLOUDLET_PES = Integer.parseInt(config.getString("dynamicLoadBalancing.CLOUDLET_PES"));
        CLOUDLET_LENGTH = Integer.parseInt(config.getString("dynamicLoadBalancing.CLOUDLET_LENGTH"));
        SCHEDULING_INTERVAL = Integer.parseInt(config.getString("dynamicLoadBalancing.SCHEDULING_INTERVAL"));;
        VM_RAM = Integer.parseInt(config.getString("dynamicLoadBalancing.VM_RAM"));;
        CLOUDLETS_INITIAL_LENGTH = Integer.parseInt(config.getString("dynamicLoadBalancing.CLOUDLETS_INITIAL_LENGTH"));;
